...
time az ml datastore upload --name workspaceblobstore --verbose --src-path datasets/$dataset_train_name --target-path ${dataset_train_name}_${dataset_version}
time az ml datastore upload --name workspaceblobstore --verbose --src-path datasets/$dataset_validate_name --target-path ${dataset_validate_name}_${dataset_version}
time az ml datastore upload --name workspaceblobstore --verbose --src-path datasets/$dataset_test_name --target-path ${dataset_test_name}_${dataset_version}
