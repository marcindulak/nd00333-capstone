...
By relaxing the `max_depth` to over 30 the model is capable of achieving the macro average recall
of over 0.87, however this does not improve the model performance on the out-of-sample dataset.
